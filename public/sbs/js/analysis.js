            ...
            if (error) {
              ...
              if (req_id === 2112) {
                 ...
                 if (data.tick && data.tick.quote !== undefined) {
                    ...
                    evenodd_array.push(lastDigit);
                    if (evenodd_array.length > evenNum) {
                      evenodd_array.shift();
                    }
                    matches_array.push(lastDigit);

                    risefall_array.push(Number(priceStr));
                    ...
                    if (isrunning) {
                      if (!status && document.getElementById("bot-status")) {
                        ...
                        var temp_prev;
                        if (risefall_array.length >= riseNum) {
                          for (var i = 0; i < risefall_array.length; i++) {
                              if (riseSide === 'RISE') {
                                if (temp_prev && risefall_array[i] < temp_prev) {
                                  isrisefall = false;
                                }
                              }
                              else {
                        ...
                        if (istrad) {
                          ...
                          console.log('is', istrad, what_to_trade)
                        }
                      }
                    }
