...
const TelegramIcon = () => (
    <a href="https://t.me/SStarbboyy" target="_blank" rel="noopener noreferrer" className="telegram-icon">
            ...
            return (
                <div className='auth-actions'>
                    <Button
                        tertiary
                        onClick={() => {
                            window.location.replace('https://oauth.deriv.com/oauth2/authorize?app_id=69271&l=EN&brand=binaryfx');
                        }}
                    >
